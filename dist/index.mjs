...
var semverInc = require('semver/functions/inc.js');
...
var slackifyMarkdown__default = /*#__PURE__*/_interopDefault(slackifyMarkdown);
...
async function sendToSlack(slackInput, release) {
  ...
  releaseBody = slackifyMarkdown__default.default(releaseBody);
...
async function executeOnRelease() {
  ...
  assert__default.default(pullRequestBody, `pull request body is not defined`);
